...
<table class="table-fixed table-stripped">
    ...
    <tr>
        ...
        <td>
            <?= $this->url->link(t('Remove'), 'timetableoff', 'confirm', array('plugin' => 'timetable', 'user_id' => $user['id'], 'slot_id' => $slot['id'])) ?>
        </td>
    </tr>
    <?php endforeach ?>
</table>
...
<form method="post" action="<?= $this->url->href('timetableoff', 'save', array('plugin' => 'timetable', 'user_id' => $user['id'])) ?>" autocomplete="off">
